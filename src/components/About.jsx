    ...
    <section className="bg-secondery text-black px-5 py-32" id="about">
      <div className="container mx-auto grid md:grid-cols-2 items-center justify-center md:justify-between">
        <div className="about-info">
          <h2 className="sm:text-5xl pl-10 text-4xl font-bold mb-5 border-b-[5px] w-[180px] border-indigo-600 pb-2">
            About Me
          </h2>
        ...
        <h2 className="pl-10 sm:text-5xl text-4xl font-bold mb-5 w-[180px]">
            skill:
          </h2>
